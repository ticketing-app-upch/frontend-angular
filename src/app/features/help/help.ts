...
@Component({
  ...
  template: `
    <div class="tkt-page">
      <span class="eyebrow">ALPATECK / GUÍA DE EXPERIENCIA</span><h1>Todo listo para vivirlo.</h1>
      ...
      <div class="steps"><article><mat-icon>explore</mat-icon><h2>01. Encuentra tu plan</h2><p>Filtra por fecha y recinto. AlpaTeck Match encuentra zonas para tu grupo dentro de tu presupuesto, incluido el servicio.</p><a routerLink="/eventos">Explorar eventos →</a></article><article><mat-icon>payments</mat-icon><h2>02. Decide con claridad</h2><p>Compara hasta tres eventos. Revisa el ajuste dinámico y la comisión del 6% antes de confirmar hasta seis entradas.</p></article><article><mat-icon>qr_code_2</mat-icon><h2>03. Prepara tu llegada</h2><p>Guarda la fecha en tu calendario, revisa tu resumen y consulta tu pase en Mis entradas.</p><a routerLink="/mis-entradas">Ver mis entradas →</a></article></div>
...
export class Help {
  ...
  readonly faqs = [
    ...
    { q: '¿Hay pagos con tarjeta, Yape o Plin?', a: 'AlpaTeck Pay te permite elegir tarjeta o billetera digital al finalizar la compra. Revisa el monto, el evento y el medio de pago antes de confirmar.' },
